...
5. Setelah agen selesai, **publikasikan sebagai artifact Claude**: baca file markdown ide. Layout: tiap ide jadi kartu — hook/angle, platform yang cocok (Threads/X/Facebook), alasan (dikaitkan ke temuan/kutipan sumbernya), dan sumbernya (link asal).
